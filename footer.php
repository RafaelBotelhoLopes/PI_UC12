    ...
    <body>
        ...
        <footer>
            <div class="region region-footer">
                ...
                <div id="block-logofooter" class="block block-block-content block-block-content9fc39f88-b809-4e47-bac7-08a55e3813b5">

                    <a href="index.php"> <img id="fotofooter" src="imagens/logositealuga.jpeg" alt="Logo Footer"/> </a>
                ...
                <div id="block-trademark" class="block block-block-content block-block-contentd7c89d85-5843-45a5-a439-256ca54b1116">
                    ...
                    <div class="field field--name-field-trademark-link field--type-link field--label-hidden field__items" style="font-size: 16px; margin-left: 20px;">
                        <div class="field__item"><a href="politicadeprivacidade.php" target="_blank">Privacy Policy</a></div>
                        <div class="field__item"><a href="termosdeuso.php" target="_blank">Terms and Conditions</a></div>
                        <div class="field__item"><a href="https://www.privacypolicies.com/live/74f49e50-c35c-41d0-a037-6f2f7f796d59" target="_blank">Do Not Sell My Personal Information</a></div>
                    </div>
            ...
            <div class="field field--name-field-trademark-address field--type-string field--label-hidden field__items" style="font-size: 10px; margin-left: 10px; margin-top: 10px; color: #e7e7e7">
                ...
                <div class="field__item" >Praia de Belas</div>
                <div class="field__item">Porto Alegre, RS</div>
                <div class="field__item">90110-150</div> <br>
            </div>
            <br>


            <div id="copyright" style="background-color: rgb(34, 34,34); text-align: center; padding: 10px;
                 font-family: 'Open Sans',sans-serif; color: rgb(130,130,130)">
                &copy; Aluga Já - 2021 - Todos os direitos reservados
            </div>
