...
<html>
    ...
    <h1 align="center" id="titulosite">Reservar  Sala / Material</h1>
    <br><br><br>

    <form align="center" action="controller/salvarReserva.php?inserir" id="frmReserva" method="POST" enctype="multipart/form-data" style="margin-bottom: 10%;">
